...
@Component({
  selector: 'app-prayer-request-management-view',
  templateUrl: './prayer-request-management-view.component.html',
  styleUrls: ['./prayer-request-management-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PrayerRequestManagementViewComponent implements OnInit, OnDestroy {
  // public
