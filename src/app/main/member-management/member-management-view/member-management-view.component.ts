...
@Component({
  selector: 'app-member-management-view',
  templateUrl: './member-management-view.component.html',
  styleUrls: ['./member-management-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MemberManagementViewComponent implements OnInit, OnDestroy {
  // public
