...
@Component({
  selector: 'app-event-management-view',
  templateUrl: './event-management-view.component.html',
  styleUrls: ['./event-management-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EventManagementViewComponent implements OnInit, OnDestroy {
  // public
