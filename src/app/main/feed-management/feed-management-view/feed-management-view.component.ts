...
@Component({
  selector: 'app-feed-management-view',
  templateUrl: './feed-management-view.component.html',
  styleUrls: ['./feed-management-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class FeedManagementViewComponent implements OnInit, OnDestroy {
  // public
