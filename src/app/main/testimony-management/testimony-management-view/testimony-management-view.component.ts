...
@Component({
  ...
  styleUrls: ['./testimony-management-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TestimonyManagementViewComponent implements OnInit, OnDestroy {
  // public
      ...
      (res: any) => {
        if (res == "nonet") {
          ...
          if (res.status == false) {
            ...
            this.router.navigate(["../testimony-management"]);
          }
        }
